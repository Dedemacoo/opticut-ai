    ...
    <div className="min-h-screen bg-[#0f172a] text-slate-200 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Yeni Hesap Oluşturun</h1>
          <p className="text-slate-400 text-sm mt-2">14 Günlük Ücretsiz Deneme ile Başlayın</p>
        </div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <input 
                ...
                placeholder="Örn: Uğur Demir"
              />
            </div>
            
            <div>
              <label className="block text-[11px] font-bold text-slate-400 mb-2 uppercase tracking-widest">Firma Adı</label>
              <input 
                type="text" 
                required
                value={company}
        ...
        <p className="text-center text-sm text-slate-400 mt-8 font-medium">
          Zaten hesabınız var mı? <Link href="/login" className="text-blue-400 hover:text-blue-300 font-bold ml-1">Giriş Yapın</Link>
        </p>
      </div>
    </div>
  );
